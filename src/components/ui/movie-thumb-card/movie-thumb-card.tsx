...
export function MovieThumbCard({
  ...
  return (
    ...
    >
      ...
      >
        {pin ? (
          <div className="pin-new absolute left-0 top-0 z-[1] flex items-center rounded-br-[var(--radius-button)] bg-[var(--accent)] px-1.5 py-0.5 text-[10px] font-semibold text-[var(--foreground)] shadow-[var(--shadow-sm)] sm:px-2 sm:py-1 sm:text-[11px]">
            {pin}
          </div>
        ) : null}
