...
export interface MovieDetailSidebarProps {
  ...
  /** Thẻ meta: IMDB, chất lượng, năm, tập, thời lượng, ngôn ngữ */
  ...
  /** Trạng thái + tiến độ tập (MovieStatusBlock) và loại phim */
  readonly status?: string;
  readonly type?: string;
  /** compact = poster nhỏ căn giữa, chỉ tags + trạng thái (dùng trên mobile) */
