...
export function WatchSkeleton({ layout = "split" }: WatchSkeletonProps) {
  const breadcrumb = (
    <div className="mb-4 hidden flex-wrap items-center gap-x-2 gap-y-1 lg:flex">
  ...
  return (
    <div className="flex h-dvh flex-col overflow-hidden lg:h-auto lg:overflow-visible lg:pb-24">
      <PageLayout className="flex min-h-0 flex-1 flex-col py-4 lg:flex-none">
        {breadcrumb}
        <div className="mt-4 grid min-h-0 flex-1 grid-cols-1 gap-6 overflow-hidden lg:grid-cols-[minmax(0,7fr)_minmax(0,3fr)] lg:items-start lg:overflow-visible">
          ...
          <div className="flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden lg:sticky lg:top-24 lg:flex-none lg:self-start">
            <div className="mb-3 flex gap-1 lg:mb-3">
              <div className="skeleton-shimmer h-9 flex-1 rounded-[var(--radius-button)]" />
              <div className="skeleton-shimmer h-9 flex-1 rounded-[var(--radius-button)]" />
              <div className="skeleton-shimmer hidden h-9 flex-1 rounded-[var(--radius-button)] sm:block" />
            </div>
